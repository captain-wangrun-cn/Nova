...
> **训练平台选型（学生侧，不是教师侧）** 的排序方案见
> [reports/d19-base-model-and-s5.md](../reports/d19-base-model-and-s5.md) 第 2.2 节：
> 建议**先本地 4060 跑通 500-1000 条的管线**，管线定型后再上 Kaggle / 云。
> 本节的成本表是**教师侧**（生成数据）的账，两者不要混。
